      ...
      <div class="md:flex md:flex-col md:h-screen">
        <div class="md:flex md:flex-shrink-0">
          ...
          <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
            <div class="mr-4 mt-1">Welcome back {{user?.name}}</div>
            <dropdown class="mt-1" placement="bottom-end">
             <!--  <template #default>
                <div class="group flex items-center cursor-pointer select-none">
                  ...
                  <icon class="w-5 h-5 fill-gray-700 group-hover:fill-slate-600 focus:fill-slate-600" name="cheveron-down" />
                </div>
              </template> -->
              <!-- <template #dropdown>
                <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" :href="`/users/2/edit`">My Profile</Link>
                  <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/users">Manage Users</Link>
                  <Link class="block px-6 py-2 w-full text-left hover:text-white hover:bg-slate-500" href="/logout" method="delete" as="button">Logout</Link>
                </div>
              </template> -->
            </dropdown>
          </div>
